...
class RNNBILSTM:
    def __init__(self):
        self.model = load_model('../RNN-LSTM/#1/modello.h5')
        with open('../RNN-LSTM/#1/tokenizer.pkl', 'rb') as f:
...
if __name__ == '__main__':
    ...
    i = 1
    with open('../RNN-BiLSTM/#0_TEST/risultato_test.txt', 'w', encoding='utf-8') as file:
